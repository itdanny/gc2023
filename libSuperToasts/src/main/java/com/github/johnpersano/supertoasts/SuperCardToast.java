...
public class SuperCardToast
{
	...
	public SuperCardToast(Context context, View cardRootView, Type type){
		initSetup(context, cardRootView, type);
	}
	/**
	...
	public SuperCardToast(Context context, Type type){
		initSetup(context, null, type);
	}
	private void initSetup(Context context, View cardRootView, Type type){
		if(context instanceof Activity || cardRootView!=null) {
			this.mContext = context;
			mLayoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			if (cardRootView==null){
				...
				mViewGroup = (ViewGroup) cardRootView;
			}			
			if (mViewGroup!=null) {
	...
	public Object getButtonTag(){
		if (mToastButton==null){
			...
			return mToastButton.getTag();	
		}		
	}
	public void setButtonTag(Object tag){
		if (mToastButton != null) {
			mToastButton.setTag(tag);
		}
	}
	/**
...
//                });
                ...
                //Dcv72 .... https://code.google.com/p/android/issues/detail?id=18803
	           	 ...
	           	 set.playTogether(
	           			 ObjectAnimator.ofFloat(mToastView, "alpha", 1f, 0f),
	           			 ObjectAnimator.ofFloat(mToastView, "translationX", viewWidth)
	           			 );
	           	 set.setDuration(500);
