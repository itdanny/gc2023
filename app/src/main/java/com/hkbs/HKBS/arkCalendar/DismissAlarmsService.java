...
//        	Intent openIntent = AlertUtils.buildEventViewIntent(this, eventId, eventStart, eventEnd);
//            TaskStackBuilder.create(this)
//                    .addParentStack(EventInfoActivity.class).addNextIntent(openIntent).startActivities();
        	//TaskStackBuilder.create(this).addParentStack(CalendarActivity.class).addNextIntent(openIntent).startActivities();
        	Intent openIntent = AlertUtils.buildEventViewIntent(this, eventId, eventStart, eventEnd);
        	//TaskStackBuilder.create(this).addParentStack(CalendarActivity.class).startActivities();
        	TaskStackBuilder.create(this).addNextIntent(openIntent).startActivities();
        }
    ...
    private String buildMultipleEventsQuery(long[] eventIds) {
    	if (DEBUG) MyUtil.log(TAG, "buildMultipleEventsQuery");
