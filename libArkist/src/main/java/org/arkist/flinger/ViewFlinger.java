...
public class ViewFlinger extends ViewGroup {
    ...
    private boolean mIsRepeatChild=false;
    
    public void setRepeatChildInFirstLevel(boolean isRepeatChild){
    	mIsRepeatChild=isRepeatChild;
    }
    ...
    void handleScreenChangeCompletion(int currentScreen) {
        ...
        //screen.requestFocus();
        try {
        	//DC 2014.07.14 use it directly
        	screen.dispatchDisplayHint(View.VISIBLE);
            //ReflectionUtils.tryInvoke(screen, "dispatchDisplayHint",new Class[]{int.class}, View.VISIBLE);
            invalidate();
...
//        }
        ...
        // DC: 2014.07.16 Comment below as useless
/*
...
*/
        ...
        if (mNextScreen != mCurrentScreen) {
            ...
            if (screenAt != null) {
            	//DC: 2014.07.16 use below to increase the performance
            	try {
            		screenAt.dispatchDisplayHint(View.INVISIBLE);
            	} catch (Exception e){
            		// Nothing
            	}
                //ReflectionUtils.tryInvoke(screenAt, "dispatchDisplayHint", new Class[]{int.class}, View.INVISIBLE);
            } else {
